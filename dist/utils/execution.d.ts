...
export declare const buildContractCall: (contract: Contract, method: string, params: any[], nonce: number, delegateCall?: boolean | undefined, overrides?: Partial<SafeTransaction> | undefined) => SafeTransaction;
export declare const executeTxWithSigners: (safe: Contract, tx: SafeTransaction, signers: Wallet[], overrides?: any) => Promise<any>;
export declare const executeContractCallWithSigners: (safe: Contract, contract: Contract, method: string, params: any[], signers: Wallet[], delegateCall?: boolean | undefined, overrides?: Partial<SafeTransaction> | undefined) => Promise<any>;
